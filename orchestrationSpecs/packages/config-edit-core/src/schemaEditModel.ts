...
let configuredUnifiedSchema: JsonSchema | undefined;

export function configureEditModelUnifiedSchema(schema: JsonSchema | undefined): void {
    configuredUnifiedSchema = schema;
}

function unifiedSchema(): JsonSchema | undefined {
    return configuredUnifiedSchema;
}
