...
export const USER_RFS_PROCESS_OPTIONS = z.object({
    ...
    failedDocumentStreamS3Bucket: z.string().optional()
        .describe("S3 bucket for the failed document stream. When omitted, falls back to the deployment-provisioned " +
            "default bucket (MIGRATIONS_DEFAULT_S3_BUCKET). Set this to use a separate bucket for failed document stream records."),
