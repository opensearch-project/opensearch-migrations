...
import {makeGcsCreateSnapshotRepoParamDict} from "./metadataMigration";
...
function makeParamsDict(
    ...
    return expr.mergeDicts(
        ...
        expr.mergeDicts(
            ...
            makeGcsCreateSnapshotRepoParamDict(expr.get(expr.deserializeRecord(snapshotConfig), "repoConfig"))
        )
    );
}


export const CreateSnapshotGcs = WorkflowBuilder.create({
    k8sResourceName: "create-snapshot-gcs",
    parallelism: 100,
