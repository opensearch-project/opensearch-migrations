...
import {
    DYNAMIC_SNAPSHOT_CONFIG_GCS, NAMED_SOURCE_CLUSTER_CONFIG_WITHOUT_SNAPSHOT_INFO
...
export const CreateOrGetSnapshotGcs = WorkflowBuilder.create({
    k8sResourceName: "create-or-get-snapshot-gcs",
    ...
    .addTemplate("createOrGetSnapshot", t => t
        ...
        .addRequiredInput("snapshotConfig", typeToken<z.infer<typeof DYNAMIC_SNAPSHOT_CONFIG_GCS>>())
        .addRequiredInput("snapshotPrefix", typeToken<string>())
        .addRequiredInput("uniqueRunNonce", typeToken<string>())
        ...
        .addSteps(b => b
            ...
            .addStep("createSnapshot", CreateSnapshotGcs, "snapshotWorkflow",
                c => c.register({
                    ...selectInputsForRegister(b, c),
