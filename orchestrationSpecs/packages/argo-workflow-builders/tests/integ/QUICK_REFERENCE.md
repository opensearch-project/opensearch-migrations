...
All features below are tested and working. See [artifacts/parity-catalog.md](artifacts/parity-catalog.md) for full results.
...
6. **Check both structure and runtime**: For model validation, assert on rendered structure AND Argo results
