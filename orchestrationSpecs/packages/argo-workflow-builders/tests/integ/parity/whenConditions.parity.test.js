    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            workflow = {
                ...
                kind: "Workflow",
                metadata: { generateName: "pwc-when-direct-", namespace: namespace },
                spec: {
                    entrypoint: "main",
...
describe("When Conditions - simple string match true", function () {
    var s = spec("simple string match true", "yes", "{{workflow.parameters.input}} == yes");
    ...
    describe("Builder - when equals", function () {
        ...
        test("builder API executes step", function () { return __awaiter(void 0, void 0, void 0, function () {
            var wf, rendered, r;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        wf = WorkflowBuilder.create({ k8sResourceName: "pwc-when-literal-true-builder" })
...
describe("When Conditions - simple string match false", function () {
    var s = spec("simple string match false", "no", "{{workflow.parameters.input}} == yes");
    describe("ArgoYaml", function () {
    ...
    describe("Builder - when equals", function () {
        ...
        test("builder API skips step", function () { return __awaiter(void 0, void 0, void 0, function () {
            var wf, rendered, r;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        wf = WorkflowBuilder.create({ k8sResourceName: "pwc-when-literal-false-builder" })
                            .addTemplate("conditional", function (t) { return t
                            .addSteps(function (s) { return s.addStepGroup(function (c) { return c; }); }); })
                            .addTemplate("main", function (t) { return t
                            .addRequiredInput("input", typeToken())
...
describe("When Conditions - expression based true", function () {
    var s = spec("expression based true", "5", "{{= asInt(workflow.parameters.input) > 3 }}");
    describe("ArgoYaml", function () {
        test("raw conditional workflow executes step", function () { return __awaiter(void 0, void 0, void 0, function () {
            var r;
            return __generator(this, function (_a) {
    ...
    describe("Builder - when numeric comparison", function () {
        ...
        test("builder API executes step", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        wf = WorkflowBuilder.create({ k8sResourceName: "pwc-when-expr-true-builder" })
                            .addTemplate("conditional", function (t) { return t
                            .addSteps(function (s) { return s.addStepGroup(function (c) { return c; }); }); })
                            .addTemplate("main", function (t) { return t
                            .addRequiredInput("input", typeToken())
...
describe("When Conditions - expression based false", function () {
    var s = spec("expression based false", "1", "{{= asInt(workflow.parameters.input) > 3 }}");
    describe("ArgoYaml", function () {
        test("raw conditional workflow skips step", function () { return __awaiter(void 0, void 0, void 0, function () {
            var r;
            return __generator(this, function (_a) {
    ...
    describe("Builder - when numeric comparison", function () {
        ...
        test("builder API skips step", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        wf = WorkflowBuilder.create({ k8sResourceName: "pwc-when-expr-false-builder" })
                            .addTemplate("conditional", function (t) { return t
                            .addSteps(function (s) { return s.addStepGroup(function (c) { return c; }); }); })
                            .addTemplate("main", function (t) { return t
                            .addRequiredInput("input", typeToken())
