...
See `artifacts/parity-catalog.md` (generated by `npm run test:integ`) for detailed results.
...
- `artifacts/parity-catalog.md` - Full test results (generated by `npm run test:integ`)
