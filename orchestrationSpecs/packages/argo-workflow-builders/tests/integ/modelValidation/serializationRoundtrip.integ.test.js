...
describe("Serialization Round-trip Tests", function () {
    test("Object param serialized as JSON string", function () { return __awaiter(void 0, void 0, void 0, function () {
        var wf, rendered, params, configParam, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    wf = WorkflowBuilder.create({ k8sResourceName: "mvs-serial-object" })
                        .addParams({
    ...
    test("Number param stays as number in YAML", function () { return __awaiter(void 0, void 0, void 0, function () {
        var wf, rendered, params, countParam, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    wf = WorkflowBuilder.create({ k8sResourceName: "mvs-serial-number" })
                        .addParams({
    ...
    test("Boolean param", function () { return __awaiter(void 0, void 0, void 0, function () {
        var wf, rendered, params, flagParam, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    wf = WorkflowBuilder.create({ k8sResourceName: "mvs-serial-bool" })
                        .addParams({
