 ...
 *  ───────────────────────────────────────────────────────────────────────── */
export function literal(value: string):  SimpleExpression<string>;
export function literal(value: number):  SimpleExpression<number>;
export function literal(value: boolean): SimpleExpression<boolean>;
export function literal(value: null):    SimpleExpression<null>;
export function literal<T extends PlainObject>(value: T): SimpleExpression<DeepWiden<T>>;
