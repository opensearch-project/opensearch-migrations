...
from cluster_migration_core.clients.rest_ops import RESTPath
...
@mock.patch("cluster_migration_core.clients.rest_ops.perform_get")
...
@mock.patch("cluster_migration_core.clients.rest_ops.perform_post")
