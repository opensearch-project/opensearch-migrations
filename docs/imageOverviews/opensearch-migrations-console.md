...
OpenSearch Migration Console is a component of the OpenSearch Migration Assistant. We recommend following the instructions in the [OpenSearch documentation](https://docs.opensearch.org/latest/migration-assistant) to get started.
