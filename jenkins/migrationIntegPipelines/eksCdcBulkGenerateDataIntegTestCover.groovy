...
eksCdcIntegPipeline(jobName: jobNameOverride ?: null, gitBranchDefault: gitBranch, defaultTestIds: '0032', defaultStageId: 'cdcbulk',
        cronSchedule: jobNameOverride?.startsWith('main-') ? 'H(15,29) 1,7,13,19 * * *' : '')
