...
eksCdcAossIntegPipeline(jobName: jobNameOverride ?: null, gitBranchDefault: gitBranch, defaultTestIds: '0034', defaultStageId: 'caoss',
        cronSchedule: jobNameOverride?.startsWith('main-') ? 'H(0,14) 4,10,16,22 * * *' : '')
