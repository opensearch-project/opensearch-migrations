...
eksCdcIntegPipeline(jobName: jobNameOverride ?: null, gitBranchDefault: gitBranch, defaultTestIds: '0030',
        cronSchedule: jobNameOverride?.startsWith('main-') ? 'H(0,14) 0,6,12,18 * * *' : '')
