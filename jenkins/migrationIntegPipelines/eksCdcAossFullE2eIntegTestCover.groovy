...
eksCdcAossIntegPipeline(jobName: jobNameOverride ?: null, gitBranchDefault: gitBranch, defaultTestIds: '0041', defaultStageId: 'ceaoss',
        cronSchedule: jobNameOverride?.startsWith('main-') ? 'H(15,29) 5,11,17,23 * * *' : '')
