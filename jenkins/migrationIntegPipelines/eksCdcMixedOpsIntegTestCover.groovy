...
eksCdcIntegPipeline(jobName: jobNameOverride ?: null, gitBranchDefault: gitBranch, defaultTestIds: '0033', defaultStageId: 'cdcmix',
        cronSchedule: jobNameOverride?.startsWith('main-') ? 'H(30,44) 2,8,14,20 * * *' : '')
