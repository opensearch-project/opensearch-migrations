...
public class IndexMetadataData_ES_9_0 implements IndexMetadata {
    @Getter
    @JsonProperty("body")
    ...
    public IndexMetadataData_ES_9_0(ObjectNode root, String indexId, String indexName) {
    ...
    public IndexMetadata deepCopy() {
        return new IndexMetadataData_ES_9_0(rawJson.deepCopy(), id, name);
    }
}
