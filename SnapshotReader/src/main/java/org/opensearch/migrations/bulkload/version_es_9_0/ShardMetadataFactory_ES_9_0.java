...
public class ShardMetadataFactory_ES_9_0 implements ShardMetadata.Factory {
    ...
    public ShardMetadata fromJsonNode(JsonNode root, String indexId, String indexName, int shardId) {
        ...
        module.addDeserializer(
            ShardMetadataData_ES_9_0.FileInfoRaw.class,
            new ShardMetadataData_ES_9_0.FileInfoRawDeserializer()
        );
        ObjectMapper objectMapper = ObjectMapperFactory.createWithModules(module);

        try {
            ObjectNode objectNodeRoot = (ObjectNode) root;
            ShardMetadataData_ES_9_0.DataRaw shardMetadataRaw = objectMapper.treeToValue(
                objectNodeRoot,
                ShardMetadataData_ES_9_0.DataRaw.class
            );
            return new ShardMetadataData_ES_9_0(
