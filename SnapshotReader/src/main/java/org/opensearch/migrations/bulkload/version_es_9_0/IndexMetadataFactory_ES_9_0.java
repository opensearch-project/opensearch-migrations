...
public class IndexMetadataFactory_ES_9_0 implements IndexMetadata.Factory {
    private final SnapshotRepo.Provider repoDataProvider;

    public IndexMetadataFactory_ES_9_0(SnapshotRepo.Provider repoDataProvider) {
    ...
    public IndexMetadata fromJsonNode(JsonNode root, String indexId, String indexName) {
        ...
        return new IndexMetadataData_ES_9_0(objectNodeRoot, indexId, indexName);
    }
    ...
    public String getIndexFileId(String snapshotName, String indexName) {
        SnapshotRepoProvider_ES_9_0 providerES710 = (SnapshotRepoProvider_ES_9_0) repoDataProvider;
