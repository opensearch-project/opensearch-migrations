...
export default function TestWizardPage() {
  return (
    <Suspense fallback={null}>
      <Container header={<Header variant="h1">Wizard Test Page</Header>}>
        <Box padding="m">
          This page demonstrates the reusable wizard component with URL-based
          step persistence. Try navigating between steps and refreshing the page
          - you should remain on the same step.
        </Box>
        <TestWizardPageInner />
      </Container>
    </Suspense>
    ...
    },
    {
      ...
      content: (
        <Box padding="l">
          ...
          <p>
            This is the content for step two. Try refreshing the page - you
            should still be on step two after refresh because of the URL
            parameter.
          </p>
    ...
    },
    {
      ...
      content: (
        <Box padding="l">
          ...
          <p>
            This is the content for step three. Try manually changing the URL
            parameter to ?step=0 or ?step=1 and see how the wizard reflects that
            change.
          </p>
