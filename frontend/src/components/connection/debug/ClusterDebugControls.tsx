...
export function ClusterDebugControls({ onScenarioSelect, onReset }: ClusterDebugControlsProps) {
  return (
    <DebugCommands>
      <SpaceBetween size="xs" direction="horizontal">
        <ButtonDropdown
          ...
          onItemClick={({ detail }) => onScenarioSelect(detail.id as keyof typeof CLUSTER_SCENARIOS)}
        >
