...
- Release tarball: `~/.opensearch-migrate/cli/<version>/lib/`
- Repo: `deployment/k8s/aws/cli/lib/` in
  `opensearch-project/opensearch-migrations` (PR #3022 — the migrate-cli
  branch). The bin/ + lib/ tree IS the spec.
