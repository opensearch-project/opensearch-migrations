...
class Test0040CdcFullE2eSimpleBulk(MATestBase):
    ...
    def prepare_workflow_parameters(self, keep_workflows: bool = False):
        # Imported-clusters variant: the EKS pipeline CDK-provisions source + target
        # and the framework imports them via configmaps when --reuse-clusters is set.
        # The -with-clusters variant would double-provision and exhaust VPC CNI IPs.
