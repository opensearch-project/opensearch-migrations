...
public class LeafReader5 implements LuceneLeafReader {
    ...
    public Iterable<DocValueFieldInfo> getDocValueFields() {
        ...
        for (FieldInfo fieldInfo : wrapped.getFieldInfos()) {
            ...
            if (dvType != DocValueFieldInfo.DocValueType.NONE) {
                ...
                fields.add(new FieldInfo5(fieldInfo.name, dvType, isBoolean));
            }
        }
        return fields;
    }
    ...
    private static class FieldInfo5 implements DocValueFieldInfo {
        private final String name;
        private final DocValueType docValueType;
        private final boolean isBoolean;

        FieldInfo5(String name, DocValueType docValueType, boolean isBoolean) {
            this.name = name;
