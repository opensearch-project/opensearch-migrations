...
public record FieldMappingInfo(
    ...
    public FieldMappingInfo(EsFieldType type, String mappingType, String format,
        ...
        this(type, mappingType, format, scalingFactor, docValues, constantValue, true);
    }
    ...
    public static FieldMappingInfo from(JsonNode fieldMapping) {
        ...
        return new FieldMappingInfo(type, typeStr, format, scalingFactor, docValues, constantValue, indexed);
    }
}
