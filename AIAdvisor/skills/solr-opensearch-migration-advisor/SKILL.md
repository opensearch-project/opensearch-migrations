...
- **Never delete content** from the file — only add or update. If a fact changes (e.g. the user corrects their Solr version), update the value and add a note explaining the change.
