...
- When in doubt about a mapping, consult `references/steering/incompatibilities.md`, `references/steering/query_translation.md`, and `references/steering/index_design.md` before responding.
