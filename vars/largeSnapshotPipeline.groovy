def call(Map config = [:]) {
    ...
    pipeline {
        ...
        parameters {
            ...
            choice(name: 'DEPLOY_REGION', choices: ['us-west-1', 'us-west-2', 'us-east-2'], description: 'AWS Region to deploy resources')
            ...
            choice(name: 'CLUSTER_VERSION', choices: ['es5x', 'es6x', 'es7x', 'os1x', 'os2x'], description: 'Target cluster version for data format')
        }
