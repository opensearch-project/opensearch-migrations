                ...
                steps {
                    timeout(time: 30, unit: 'MINUTES') {
                        script {
                            ...
                            def pullThroughCacheEndpoint = "${accountId}.dkr.ecr.us-east-1.amazonaws.com"
                            sh "./gradlew :buildImages:buildImagesToRegistry_amd64 -x test --info --stacktrace --profile --scan -PpullThroughCacheEndpoint=${pullThroughCacheEndpoint}"
