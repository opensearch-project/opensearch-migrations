def call(Map config = [:]) {
    ...
    pipeline {
        ...
        parameters {
            ...
            string(name: 'GIT_BRANCH', defaultValue: 'jenkins-bug-fixes', description: 'Git branch to use for repository')
            string(name: 'STAGE', defaultValue: "${defaultStageId}", description: 'Stage name for deployment environment')
            string(name: 'VPC_ID', defaultValue: "vpc-07d3e089b8e9139e4", description: 'VPC to use for deployments')
        }
