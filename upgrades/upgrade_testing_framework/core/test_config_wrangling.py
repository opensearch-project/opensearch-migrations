...
class TestConfigCantReadFileException(Exception):
    def __init__(self, test_config_path_full, original_exception):
        super().__init__(f"Unable to read test config file at path {test_config_path_full}."
                         f" Details: {str(original_exception)}")


class TestConfigFileNotJSONException(Exception):
    def __init__(self, test_config_path_full, original_exception):
        super().__init__(f"The test config at path {test_config_path_full} is not parsible as JSON."
                         f" Details: {str(original_exception)}")
