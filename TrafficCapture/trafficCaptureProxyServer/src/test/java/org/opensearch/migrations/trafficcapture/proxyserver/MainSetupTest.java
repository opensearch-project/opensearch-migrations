...
public class MainSetupTest {
    ...
    public void testBuildKafkaPropertiesWithMSKAuth() throws IOException {
        ...
        Assertions.assertEquals("software.amazon.msk.auth.iam.IAMClientCallbackHandler", props.get(SaslConfigs.SASL_CLIENT_CALLBACK_HANDLER_CLASS));
    }
    ...
    public void testBuildKafkaPropertiesWithPropertyFile() throws IOException {
        ...
        Assertions.assertEquals("org.apache.kafka.common.serialization.ByteArraySerializer", props.get(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG));
