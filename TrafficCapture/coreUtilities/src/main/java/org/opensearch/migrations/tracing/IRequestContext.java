...
public interface IRequestContext extends IConnectionContext {
    ...
    default AttributesBuilder fillAttributes(AttributesBuilder builder) {
        return IConnectionContext.super.fillAttributes(
                builder.put(SOURCE_REQUEST_INDEX_KEY, sourceRequestIndex()));
    }
}
