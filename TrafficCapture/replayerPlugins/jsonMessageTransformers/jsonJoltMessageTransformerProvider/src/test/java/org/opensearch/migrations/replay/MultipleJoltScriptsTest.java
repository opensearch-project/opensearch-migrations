...
public class MultipleJoltScriptsTest {
    ...
    public void testAddGzip() throws Exception {
        ...
        Assertions.assertEquals("testhostname", ((Map) newDoc.get(JsonKeysForHttpMessage.HEADERS_KEY))
                .get("host"));
        Assertions.assertEquals("gzip", ((Map) newDoc.get(JsonKeysForHttpMessage.HEADERS_KEY))
