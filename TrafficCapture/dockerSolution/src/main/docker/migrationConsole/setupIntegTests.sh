...
pytest tests.py --proxy_endpoint="http://opense-clust-qM5vY33YeBef-dde6b54655fcc296.elb.us-east-1.amazonaws.com:9200" --source_endpoint="http://opense-clust-qM5vY33YeBef-dde6b54655fcc296.elb.us-east-1.amazonaws.com:19200" --target_endpoint="$MIGRATION_DOMAIN_ENDPOINT" --source_auth_type="none" --target_auth_type="none" --source_verify_ssl=False --target_verify_ssl=False --deployment_type="cloud" --verbose
deactivate