...
#pytest tests.py
pytest tests.py::E2ETests::test_0001_index tests.py::E2ETests::test_0002_document  --proxy_endpoint="http://opense-clust-qM5vY33YeBef-dde6b54655fcc296.elb.us-east-1.amazonaws.com" --source_endpoint="http://opense-clust-qM5vY33YeBef-dde6b54655fcc296.elb.us-east-1.amazonaws.com" --target_endpoint="$MIGRATION_DOMAIN_ENDPOINT" --source_auth_type="none" --target_auth_type="none" --source_verify_ssl=False --target_verify_ssl=False
deactivate