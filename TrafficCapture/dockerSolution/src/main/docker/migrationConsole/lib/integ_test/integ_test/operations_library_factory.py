...
from .elasticsearch_operations import (
    ElasticsearchV1_XOperationsLibrary, ElasticsearchV2_XOperationsLibrary,
    ElasticsearchV5_XOperationsLibrary, ElasticsearchV6_XOperationsLibrary,
    ElasticsearchV6_8OperationsLibrary, ElasticsearchV7_XOperationsLibrary, ElasticsearchV8_XOperationsLibrary
)
...
def get_operations_library_by_version(version: ClusterVersion):
    ...
    elif is_incoming_version_supported(limiting_version=ElasticsearchV6_8, incoming_version=version):
        return ElasticsearchV6_8OperationsLibrary()
