from .cluster_version import (ClusterVersion, ElasticsearchV2_X, ElasticsearchV5_X, ElasticsearchV6_X,
                              ElasticsearchV7_X, ElasticsearchV8_X, OpensearchV1_X, OpensearchV2_X,
                              is_incoming_version_supported)
from .elasticsearch_operations import (ElasticsearchV2_XOperationsLibrary, ElasticsearchV5_XOperationsLibrary,
                                       ElasticsearchV6_XOperationsLibrary, ElasticsearchV7_XOperationsLibrary,
                                       ElasticsearchV8_XOperationsLibrary)
...
def get_operations_library_by_version(version: ClusterVersion):
    if is_incoming_version_supported(limiting_version=ElasticsearchV2_X, incoming_version=version):
