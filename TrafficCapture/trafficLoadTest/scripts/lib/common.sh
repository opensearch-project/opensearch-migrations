...
# with deployment/k8s/examples/cdc-load-test/deployCdcLoadTestConfig.sh up). k6 runs are submitted
# as Argo Workflows through the migration console (`loadtest …`); assertions query the in-cluster
