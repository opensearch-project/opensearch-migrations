...
/**
 * End-to-end migration of a standalone Solr 7 backup whose flat Lucene index sits directly at the S3
 * repo prefix (segments_N at the root, no {@code snapshot.<name>/} wrapper), through the real
 * {@code RfsMigrateDocuments} S3 path. Complements {@link SolrBareS3StandaloneDocumentMigrationTest},
 * which covers the wrapped {@code snapshot.<name>/} sub-directory layout.
 */
@Slf4j
@Tag("isolatedTest")
@Testcontainers
public class SolrBareS3StandaloneFlatRootDocumentMigrationTest {

    private static final ObjectMapper MAPPER = new ObjectMapper();
    private static final String BUCKET_NAME = "solr-bare-s3-flatroot";
