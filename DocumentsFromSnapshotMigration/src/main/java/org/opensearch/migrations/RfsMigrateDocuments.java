...
public class RfsMigrateDocuments {
    ...
    /**
     * Pipeline-based document migration entry point. Uses the clean pipeline architecture
    ...
    public static CompletionStatus runWithPipeline(
        ...
        var runner = org.opensearch.migrations.bulkload.pipeline.PipelineRunner.builder()
            .extractor(extractor)
            .targetClient(targetClient)
            .snapshotName(snapshotName)
            .workDir(workDir)
