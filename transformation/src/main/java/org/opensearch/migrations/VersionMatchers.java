...
public class VersionMatchers {
    ...
    public static final Predicate<Version> isES_6_0_to_6_5 = VersionMatchers.equalOrGreaterThanMinorVersion(Version.fromString("ES 6.0"))
                                                                .and(VersionMatchers.equalOrLessThanMinorVersion(Version.fromString("ES 6.5")));
    public static final Predicate<Version> isES_6_5_orAbove = VersionMatchers.equalOrGreaterThanMinorVersion(Version.fromString("ES 6.5"));
