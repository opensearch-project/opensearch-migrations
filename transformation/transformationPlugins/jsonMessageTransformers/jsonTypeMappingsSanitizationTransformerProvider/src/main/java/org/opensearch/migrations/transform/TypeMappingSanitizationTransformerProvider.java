...
public class TypeMappingSanitizationTransformerProvider extends JsonJSTransformerProvider {
    ...
    public IJsonTransformer createTransformer(Object jsonConfig) {
        try {
            ...
            var config = validateAndExtractConfig(jsonConfig, new String[]{}, new String[]{STATIC_MAPPINGS,REGEX_MAPPINGS, FEATURE_FLAGS, SOURCE_PROPERTIES_KEY});
            ...
            throw new IllegalArgumentException(getConfigUsageStr(STATIC_MAPPINGS, REGEX_MAPPINGS, FEATURE_FLAGS), e);
        }
    }
