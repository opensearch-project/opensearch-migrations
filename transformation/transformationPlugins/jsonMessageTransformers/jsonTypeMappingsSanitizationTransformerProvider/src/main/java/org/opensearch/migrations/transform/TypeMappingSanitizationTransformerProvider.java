...
public class TypeMappingSanitizationTransformerProvider extends JsonJSTransformerProvider {
    ...
    public IJsonTransformer createTransformer(Object jsonConfig) {
        try {
            ...
            var config = validateAndExtractConfig(jsonConfig, new String[]{}, new String[]{STATIC_MAPPINGS,
                REGEX_INDEX_MAPPINGS, FEATURE_FLAGS, SOURCE_PROPERTIES_KEY});
            ...
            throw new IllegalArgumentException(getConfigUsageStr(STATIC_MAPPINGS, REGEX_INDEX_MAPPINGS, FEATURE_FLAGS), e);
        }
    }

    @Override
    protected String getConfigUsageStr(String... expectedKeys) {
        return this.getClass().getName() + " " +
            "expects the incoming configuration to be a Map<String, Object>, " +
            "with values '" + String.join("', '", expectedKeys) + "'.  " +
