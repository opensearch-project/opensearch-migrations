...
public class ItemsTest {
    ...
    void testIndexTemplatesFailures() throws Exception {
        var items = createEmptyItemsBuilder()
            .indexTemplates(List.of(
                CreationResult.builder().name("it1").failureType(CreationFailureType.TEMPLATE_ALREADY_EXISTS).build(),
        ...
        assertThat(jsonOutput.toPrettyString(), failure1.get("type").asText(), equalTo("TEMPLATE_ALREADY_EXISTS"));
