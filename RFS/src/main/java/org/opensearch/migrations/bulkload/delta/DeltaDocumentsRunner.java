...
public class DeltaDocumentsRunner {
    ...
    private Flux<WorkItemCursor> setupDocMigration(
        ...
        Flux<RfsLuceneDocument> documents = reader.readDeltaDocuments(baseShardMetadata.getSegmentFileName(),
            shardMetadata.getSegmentFileName(), workItem.getStartingDocId());
