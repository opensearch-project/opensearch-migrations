...
@Getter
public class ShardMetadataData_ES_5_6 implements ShardMetadata {
    ...
    public ShardMetadataData_ES_5_6(
        String snapshotName,
        String indexName,
        String indexId,
        int shardId,
    ...
    public static class FileInfoRawDeserializer extends JsonDeserializer<FileInfoRaw> {
        ...
        public FileInfoRaw deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException {
            ...
            return new FileInfoRaw(name, physicalName, length, checksum, writtenBy, metaHash);
        }
    }
}
