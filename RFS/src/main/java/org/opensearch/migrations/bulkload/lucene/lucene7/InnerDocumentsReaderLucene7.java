...
@Slf4j
public class InnerDocumentsReaderLucene7 implements InnerDocumentsReader {
     ...
     */
    Publisher<RfsLuceneDocument> readDocsByLeavesFromStartingPosition(MyReader reader, int startSegmentIndex, int startDocId) {
