...
public class SnapshotReader_ES_5_6 implements ClusterSnapshotReader {
    ...
    public GlobalMetadata.Factory getGlobalMetadata() {
        return new GlobalMetadataFactory_ES_5_6(getSnapshotRepo());
    }

    @Override
    public IndexMetadata.Factory getIndexMetadata() {
        return new IndexMetadataFactory_ES_5_6(getSnapshotRepo());
    }

    @Override
    public ShardMetadata.Factory getShardMetadata() {
        return new ShardMetadataFactory_ES_5_6(getSnapshotRepo());
    }

    @Override
    public int getBufferSizeInBytes() {
        return ElasticsearchConstants_ES_5_6.BUFFER_SIZE_IN_BYTES;
    }

    @Override
    public boolean getSoftDeletesPossible() {
        return ElasticsearchConstants_ES_5_6.SOFT_DELETES_POSSIBLE;
    }

    @Override
    public String getSoftDeletesFieldData() {
        return ElasticsearchConstants_ES_5_6.SOFT_DELETES_FIELD;
    }
    ...
    private SnapshotRepo.Provider getSnapshotRepo() {
        ...
        return new SnapshotRepoProvider_ES_5_6(sourceRepo);
    }
