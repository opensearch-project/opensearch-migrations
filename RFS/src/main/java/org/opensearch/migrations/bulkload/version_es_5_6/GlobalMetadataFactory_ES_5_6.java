...
public class GlobalMetadataFactory_ES_5_6 implements GlobalMetadata.Factory {
    private final SnapshotRepo.Provider repoDataProvider;

    public GlobalMetadataFactory_ES_5_6(SnapshotRepo.Provider repoDataProvider) {
    ...
    public GlobalMetadata fromJsonNode(JsonNode root) {
        ...
        return new GlobalMetadataData_ES_5_6(metadataRoot);
    }
