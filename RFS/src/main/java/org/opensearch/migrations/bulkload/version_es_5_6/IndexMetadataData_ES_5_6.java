...
public class IndexMetadataData_ES_5_6 extends IndexMetadata {
    @Getter
    @JsonProperty("body")
    ...
    public IndexMetadataData_ES_5_6(ObjectNode root, String indexId, String indexName) {
        this.rawJson = root;
        this.mappings = null;
        this.settings = null;
        this.id = indexId;
    ...
    public IndexMetadata deepCopy() {
        return new IndexMetadataData_ES_5_6(rawJson.deepCopy(), id, name);
    }
}
