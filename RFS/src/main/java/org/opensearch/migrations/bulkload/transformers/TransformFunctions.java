...
public class TransformFunctions {
    ...
    public static Transformer getTransformer(
        ...
        if (VersionMatchers.isOS_2_X.or(VersionMatchers.isOS_1_X).or(VersionMatchers.isOS_3_X).test(targetVersion)) {
            ...
            if (VersionMatchers.isOS_1_X.or(VersionMatchers.isOS_2_X).or(VersionMatchers.isOS_3_X).test(sourceVersion)) {
                return new Transformer_ES_7_10_OS_2_11(awarenessAttributes);
            }
        }
